<header class="main-header">
  ...
  <nav class="navbar navbar-static-top" onclick="datatableonadjustscreenwidth();" style="background-color: <?php echo $_SESSION['dbcolor'] ?>;">
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left"> <a href="<?php echo site_url('Welcome/ChangePassword');?>" class="btn btn-block btn-flat">Change Password</a> </div>
    ...
    <div class="user-panel">
      <div class="image">
        <h4 class="center text-center">
          <?php echo $_SESSION['officename']; ?> - <span id="hours"> <?php echo $hr; ?> </span> : <span id="minutes"> <?php echo $min; ?></span> : <span id="seconds"><?php echo $sec; ?></span> <?php echo $type; ?>
        </h4>
      </div>
    </div>
    <ul class="sidebar-menu" data-widget="tree">
      <?php
      echo $_SESSION['RenderedMenu']['DashboardMenu'];
      ?>
  </section>
</aside>