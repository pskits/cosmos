...
class SalesReturnClass extends CI_Model
{
    ...
    {
         $qry = "".$_SESSION['currentdatabasename'].".dbo.Exec_TransSalesReturnRequestProductStatus '" . $_POST['SerialNo'] . "', '" . $_POST['Status'] . "','" . $_POST['User_Id'] . "'	";
        $query = $this->db->query($qry);
        if ($query) {
            $this->session->set_flashdata('msgS', 'Success!!!');
        } else {
    ...
    {
        $qry = "".$_SESSION['currentdatabasename'].".dbo.Exec_TransSalesReturnStatus '" . $_POST['SalesReturn_Id'] . "','" . $_POST['SalesReturn_status_Id'] . "','" . $_POST['User_Id'] . "'	";
        $query = $this->db->query($qry);
        if ($query) {
            $this->session->set_flashdata('msgS', 'Success!!!');
        } else {
    ...
    {
        $qry = "".$_SESSION['currentdatabasename'].".dbo.Exec_TransSalesReturnRequestStatus '" . $_POST['SalesReturnRequest_Id'] . "'
		,'" . $_POST['Status_Id'] . "',
		'" . $_POST['User_Id'] . "'	";
        $query = $this->db->query($qry);
        if ($query) {
    ...
    function SalesReturnReplacement_Save()
    {
        ...
        // $query = $this->db->query($qry); 
        $qry = "".$_SESSION['currentdatabasename'].".dbo.Exec_TransSalesReturnReplaceable '" . $_POST['SalesReturn_Id'] . "','" . $_POST['User_Id'] . "'	";
        $query = $this->db->query($qry);
        if ($query) {
            $this->session->set_flashdata('msgS', 'Success!!!');
    ...
    {
        $qry = "".$_SESSION['currentdatabasename'].".dbo.Exec_TransSalesReturn '" . $_POST['SalesReturnRequest_Id'] . "'
        ...
        if ($lastid) {
            ...
            foreach ($Product as $key => $n) {
                $prdquery = "0";
                $prdqry = "nil";
                $prdqry = "".$_SESSION['currentdatabasename'].".dbo.Exec_TransSalesReturnProduct '" . $lastid . "'
                                ,'" . $Invoice_id[$key] . "'
                                 ,'" . $Product[$key] . "'
                                 ,'" . $Tax_Id[$key] . "'
                                ,'" . $Qty[$key] . "'
