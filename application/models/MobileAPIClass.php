...
class MobileAPIClass extends CI_Model
{
	...
	{
		$qry =  $_POST['db'] . ".dbo.Exec_Collection '" . $_POST['Dealer_Id'] . "'
		,'" . $_POST['User_Id'] . "'
		,'" . $_POST['Portal_Id'] . "'
		,'" . $_POST['lat'] . "'
		,'" . $_POST['lng'] . "'
	...
	function InvoicegoodsDelivery_Save()
	{
		...
		$qry .= "Exec ".$_POST['db'] . ".dbo.exec_InvoicegoodsDelivery '" . $Serial_No . "'		
		,'" . $_POST['productid'] . "'
			,'" . $_POST['invoiceid'] . "'
			,'" . $_POST['goods_status_Id'] . "'
     		,'" . $_POST['User_Id'] . "';";
	...
	{
		$qry = "register_device '" . $_POST['isVirtual'] . "'
		,'" . $_POST['manufacturer'] . "'
		,'" . $_POST['model'] . "'
		,'" . $_POST['platform'] . "'
		,'" . $_POST['serial'] . "'
	...
	{
		$qry = "mobile_DeviceCodeConfirmation '" . $_POST['deviceid'] . "'
		,'" . $_POST['devicecode'] . "'	
        ";
		$query = $this->db->query($qry);
		if ($query) {
	...
	{
		$qry = $_POST['db'] . ".dbo.Exec_TransSalesReturnRequest '" . $_POST['Dealer_Id'] . "'
