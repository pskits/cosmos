    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Bank Reconciliation (unreconciled)</h3>
                ...
                <table id="Viewtable" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['Bank_Id'])) {
                            foreach ($this->GM->Bankreconciliation_unreconciled($from_date, $to_date, $_GET['Bank_Id']) as $Row) {
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge" onclick="AcceptBankReconcillation('<?php echo $Row->Transactions_Id; ?>');"><i class="fa fa-pencil"></i></span>  
                                    </td>
                                </tr>
                        <?php
