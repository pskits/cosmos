  ...
  <section class="content">
    <div class="box box-form box-solid">
      ...
      <div class="box-body">
            ...
            <?php
            $cou = 1;
            foreach ($this->GM->ProductionComplete($status="1",$Production_Id) as $Row) {
            ?>
           
               <div class="container-fluid row ">
             
                <div class="col-sm-3   invoice-col">
                <h4 >Production No:</h4><h4><b><?php echo $Row->Production_Code; ?></b></h4><br>
                </div>
                <div class="col-sm-3   invoice-col">
                <h4 >Office:</h4><h4><b><?php echo $Row->office_Name; ?></b></h4><br>             
                
              </div>
                <div class="col-sm-3 invoice-col pull-right">
                <h4 >Batch :</h4><h4><b><?php echo $Row->BatchNo; ?></b></h4><br>
                </div>
                <div class="col-sm-3   invoice-col">
                <h4 >Production date:</h4><h4> <b><?php echo $Row->Production_date_Dateformatted; ?></b></h4>
              </div>
                <!-- /.col -->
