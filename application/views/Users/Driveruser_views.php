    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Driver View</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Users/Driver_View'); ?>" class="btn btn-flat bg-grayy" style="background:#f9f9f9;color:#1a2226;"><i class="fa fa-caret-left"></i> Back</a>
                    <a href="<?php echo site_url('Users/Driveruser_Views') . '/?Key=' . $_GET['Key']; ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1-1">
                            ...
                            <?php
                            foreach ($this->GM->Driver(1, $_GET['User_Id']) as $user) {
                            ?>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body row">
                                    <table class="table table-bordered display nowrap" style="width:100%">
                                        <?php
                                        $salarydata = $this->GM->Salary($UserRole_Id, $pay_type = "0", $status = "1", $user->Driver_Id);
                                    ...
                                    <table class="table table-bordered display nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $pay = 0;
                                            $deduction = 0;
                                            foreach ($this->GM->payable($UserRole_Id, $user->Driver_Id, '') as $SalaryAmount) {
                                            ?>
                                                <tr>
                        ...
                        <div class="tab-pane" id="tab_3-1">
                            ...
                            <div class="box box-primary">
                                <?php
                                $Attendanceuserlistdata = $this->GM->AttendanceUserlist($status = "1", $id = "0", $UserRole_Id, $user->Driver_Id);
                        ...
                        <div class="tab-pane" id="tab_4-1">
                            <?php
                            $directory = log_directory . "/" .$_SESSION['currentdatabasename']. "/" . $UserRole_Id . "/" . $user->Driver_Id;
                            if (!is_dir($directory)) {
