      ...
      <div class="box-body">
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <select onchange='Suppilerdetails(this)' class="form-control select2" required id="Bill_Supplier_Id" name="Bill_Supplier_Id">
                <?php
                $data = $this->GM->Supplier($status_id = "1", $Warehouse_id = "0", '0');
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="text" readonly class="form-control input-sm Date" name="Bill_Date" id="Bill_Date" placeholder="Enter Bill Date">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control input-md" required name="Bill_Reference" placeholder="Enter  Reference" value="<?php echo @set_value('Bill_Reference') . @$Bill_Reference; ?>">
            ...
            <div class="table-responsive">
              <table class="table">
                <tr>
                  ...
                  <td><input type="text" class="borderless" name="Bill_Subtotal" required readonly id="Bill_Subtotal" value="<?php echo @set_value('Bill_Subtotal') . @$Bill_Subtotal;  ?>"></td>
                </tr>
                <tr>
                  <th>Discount</th>
                  <td><input type="text" class="borderless" name="Bill_TotalDiscountAmount" required readonly id="Bill_TotalDiscountAmount" value="<?php echo @set_value('Bill_TotalDiscountAmount') . @$Bill_TotalDiscountAmount;  ?>"></td>
                </tr>
                <tr>
                  <th>Tax</th>
                  <td><input type="text" class="borderless" id="Bill_TotalTaxAmount" required readonly name="Bill_TotalTaxAmount" value="<?php echo @set_value('Bill_TotalTaxAmount') . @$Bill_TotalTaxAmount;  ?>"></td>
                </tr>
				<tr>
                  <td>Fright</td>
                ...
                <tr>
                  <th>Total</th>
                  <td><input type="text" class="borderless" id="Bill_GrandTotalAmount" required readonly name="Bill_GrandTotalAmount" value="<?php echo @set_value('Bill_GrandTotalAmount') . @$Bill_GrandTotalAmount;  ?>"></td>
                </tr>
              </table>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label>Terms</label>
              <input type="text" class="form-control input-md" required name="Bill_terms" placeholder="Enter Terms" value="<?php echo @set_value('Bill_terms') . @$Bill_terms; ?>">
              <?php echo form_error('Bill_terms'); ?>
            </div>
            <div class="form-group">
              <label>Description</label>
              <input type="text" class="form-control input-md" required name="Bill_Description" placeholder="Enter Description" value="<?php echo @set_value('Bill_Description') . @$Bill_Description; ?>">
...
var Insurance = document.getElementById('Insurance').value; 
    ...
    $("input[id='productqty']").each(function(index) {
      ...
      var Taxval = ((parseFloat(output) / 100) * parseFloat(Taxpercentage)).toFixed(2);
	...
	totalPrice = (parseFloat(totalPrice) + parseFloat(Fright)).toFixed(2);
   
			      totalPrice = (parseFloat(totalPrice) + parseFloat(Insurance)).toFixed(2);
