    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Flow by Books</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/InventoryFlowbyBooks'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
            <br>
                 ...
                 <table class="table exporttable" style="width:100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Product</th>                        
                            <th>Opening usable</th>
                            <th>Opening Unusable</th>
                            <th>Imported</th>
                            <th>invoiced</th>
                            <th>Sales return </th>
                            <th>Warenty return</th>
                            <th>Closing usable</th>
                            <th>Closing Unusable</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $Row->openingPurchasedusable+$Row->openingSalesReturnUsableNotOutwared+$Row->openingSalesReturnUsableOutwared; ?></td>
                                <td><?php echo $Row->openingununsable; ?></td>
                                <td><?php echo $Row->importedstock; ?></td>
                                <td><?php echo $Row->invoicedstock; ?></td>
                                <td><?php echo $Row->salesreturnstock; ?></td>
                                <td><?php echo $Row->warentyreturn; ?></td>
                                <td><?php echo $Row->closingPurchasedusable+$Row->closingSalesReturnUsableNotOutwared+$Row->closingSalesReturnUsableOutwared; ?></td>
                                <td><?php echo $Row->closingununsable; ?></td>
                    ...
                    <tfoot><?php $tablecolumntotallist = array('2', '3', '4', '5', '6', '7', '8', '9'); ?>
                        <td>Total</td>
                        <td></td>
                        <td></td>
                        <td></td>
