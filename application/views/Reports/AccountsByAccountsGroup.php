            ...
            <div class="box-body">
                ...
                <table class="table exporttable table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>                               
                                <td><a href="<?php echo site_url('Reports/AccountsByAccountsGroupLedger') . '/?OfficeLedger_Id='.$Row->OfficeLedger_Id.'&fromdate='.$fromdate.'&todate'.$todate; ?> "><?php echo $Row->Ledgername; ?></a></td>
                                <td><?php echo ($Row->openingamount < 0) ?  ($Row->openingamount * -1) : 0; ?></td>
                                <td><?php echo ($Row->openingamount > 0) ?  $Row->openingamount : 0; ?></td>
								<td><?php echo ($Row->amount < 0) ?  ($Row->amount * -1) : 0; ?></td>
                                <td><?php echo ($Row->amount > 0) ?  $Row->amount : 0; ?></td>
