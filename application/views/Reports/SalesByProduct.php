    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">By Product</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/SalesByProduct'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                <br>
                ...
                <hr class="horizondal-splitter">
                 <table class="table exporttable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($this->ReportsClass->SalesByProduct($from_date, $to_date) as $Row) {
                        ?>
                            <tr>
