    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Accessories Sales with Stock</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/SalesbyAccessoriesSaleswithStock'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                <br>
                ...
                <hr class="horizondal-splitter">
                 <table class="table exporttable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($this->ReportsClass->SalesbyAccessoriesSaleswithStock($from_date, $to_date) as $Row) {
                        ?>
                            <tr>
                                ...
                                <td class="Currency"><?php echo $Row->QPH1; ?></td>
                                <td class="Currency"><?php echo $Row->QPV1; ?></td>
                                <td class="Currency"><?php echo $Row->FS12M; ?></td>
                                <td class="Currency"><?php echo $Row->FS13M; ?></td>
                                <td class="Currency"><?php echo $Row->FS14M; ?></td>
                                <td class="Currency"><?php echo $Row->FSITotal; ?></td>
                            </tr>
                        <?php
                    ...
                    <tfoot><?php $tablecolumntotallist = array('4', '5', '6', '7', '8', '9', '10'); ?>
                        <td>Total</td>
                        <td></td>
                        <td></td>
                        <td></td>
