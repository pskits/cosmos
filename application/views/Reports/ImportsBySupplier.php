        ...
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/ImportsBySupplier'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                <br>
                ...
                <hr class="horizondal-splitter">
                 <table class="table exporttable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($this->ReportsClass->ImportsBySupplier($from_date, $to_date) as $Row) {
                        ?>
                            <tr>
                                <td><b><?php echo $cou; ?></b></td>
                                <td><?php echo $Row->name; ?></td>
                                <td><?php echo $Row->Currencycode; ?></td>
                                <td><?php echo $Row->BillCount; ?></td>                                
                                <td><?php echo $Row->Before_importtotal; ?></td>
                                <td><?php echo $Row->importtotal; ?></td>
                            </tr>
                        <?php
                            $cou++;
                        }
