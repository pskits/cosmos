    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">by ReturnNo</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/ReturnbyReturnNo'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
            <br>
                ...
                <hr class="horizondal-splitter">
                 <table class="table exporttable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        $cou = 1;
                        foreach ($this->ReportsClass->ReturnbyReturnNo($from_date, $to_date) as $Row) {
                        ?>
                            <tr>
                    ...
                    <tfoot><?php $tablecolumntotallist = array('6','7','8','9'); ?>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
