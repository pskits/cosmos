    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">By Credit Period</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/SalesByCreditPeriod'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                <br>
                ...
                <hr class="horizondal-splitter">
                 <table class="table exporttable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($this->ReportsClass->SalesByCreditPeriod($from_date, $to_date) as $Row) {
                        ?>
                            <tr>
                                ...
                                <td><?php echo $Row->InvoiceProduct_subtotal; ?></td>
                                <td><?php echo $Row->InvoiceProduct_discount_total; ?></td>
                                <td><?php echo $Row->InvoiceProduct_tax_total; ?></td>
                                <td><?php echo $Row->InvoiceProduct_total; ?></td>
                            </tr>
                        <?php
                            $cou++;
                        }
                    ...
                    <tfoot><?php $tablecolumntotallist = array('4', '5', '6', '7'); ?>
                        <td>Total</td>
                        <td></td>
                        <td></td>
                        <td></td>
