...
class ReportsClass extends CI_Model
{
	...
	//Rep_InventoryPurchaseorder
	function Inventorypurchaseorder()
	{
		$res = $this->db->query("exec ".$_SESSION['currentdatabasename'].".dbo.Rep_InventoryPurchaseorder");
		return $res->result();
	}
	...
	function InventoryPurchaseOrderDetails()
	{
		$res = $this->db->query("exec ".$_SESSION['currentdatabasename'].".dbo.Rep_InventoryPurchaseOrderDetails");
		return $res->result();
	}
	...
	function AccountsBybalancesheet($AccountsGroupParent_Id, $from_date, $to_date)
	{
		$res = $this->db->query("exec ".$_SESSION['currentdatabasename'].".dbo.Rep_AccountsBybalancesheet  '" . $AccountsGroupParent_Id . "', '" . $from_date . "','" .  $to_date . "'");
		// echo $this->db->last_query();exit;
		return $res->result();
	}
	//AccountsBybalancesheetLedgerGroupwise
	function AccountsBybalancesheetLedgerGroupwise($AccountsGroupParent_Id, $from_date, $to_date)
	{
		$res = $this->db->query("exec ".$_SESSION['currentdatabasename'].".dbo.Rep_AccountsBybalancesheetLedgerGroupwise  '" . $AccountsGroupParent_Id . "', '" . $from_date . "','" .  $to_date . "'");
		// echo $this->db->last_query();exit;
		return $res->result();
	}
	...
	{
		$res = $this->db->query("exec ".$_SESSION['currentdatabasename'].".dbo.Get_Stock '" . $date . "'");
		// echo $this->db->last_query();exit;
		return $res->result();
	}
	// Replacement Report 
	function ReturnbyReplacementInvoiceNo($from_date, $to_date)
	{
		$res = $this->db->query("exec ".$_SESSION['currentdatabasename'].".dbo.Rep_ReturnbyReplacementInvoiceNo '" . $from_date . "','" . $to_date . "'");
		// echo $this->db->last_query();exit;
		return $res->result();
	}
