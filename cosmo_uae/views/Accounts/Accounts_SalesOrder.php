...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Accounts Sales Order Creation</h1>
  </section>
  <section class="content">
    <div class="box box-form box-solid">
      <div class="box-header with-border">
        <h3 class="box-title">Accounts Sales Order Creation Details</h3>
        <div class="box-tools pull-right">
          <a href="<?php echo site_url('Accounts/Accounts_Orderlist'); ?>" class="btn btn-flat"><i class="fa fa-search"></i> View</a>
        </div>
      </div>
      <div style="color:red">

      </div>
      <?php echo form_open_multipart(site_url('Accounts/AddOrder_Accounts'), 'role="form"'); ?>
      ...
      <div class="box-footer">
        <a href="<?php echo site_url('Accounts/Accounts_SalesOrder'); ?>" class="btn btn-flat bg-red"><i class="fa fa-times"></i> Reset</a>
