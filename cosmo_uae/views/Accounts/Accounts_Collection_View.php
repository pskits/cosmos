...
<div class="content-wrapper">
  <section class="content-header">
    <h1>Accounts Collection View</h1>
  </section>
    ...
    <div class="box box-form box-solid">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <a href="<?php echo site_url('Accounts/Accounts_Collection_View'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
        </div>
      </div>
      <div class="box-body">
        <br>
        ...
        <table id="Viewtable" class="display nowrap" style="width:100%">
          ...
          <tbody>
            ...
            foreach ($this->GM->AccountsCollection($status = "1", $dealer = "0", $collectedUser_Id = "0", $portal_Id = "0", $process_Id = "0", $amountmode_Id = "0", $CollectionStatus_Id = "0", $Id = "0", $from_date, $to_date, $accountstatus=2) as $Row) {
            ?>
              <tr>
                ...
                <td>
                  <a <?php echo "href='" . site_url('') . "/" . "Collection/Collection_invoice/?Key=" . base64_encode($Row->Colletion_Id) . "'"; ?>><span class="badge"><i class="fa fa-eye"></i>&nbsp; View</span>
                  </a>
                </td>
              </tr>
            <?php
