                    ...
                    <div class="col-12">
                        <div class="callout callout-info row">
                            ...
                            <div class="col-md-8">
                                ...
                                <a href="<?php echo site_url('Accounts/Voucher_view'); ?>" style="background-color:#0ea3a9;margin-right:1px;" class="btn btn-flat pull-right"><i class="fa fa-arrow-circle-left"></i> </a>
 <a onclick="askapprovalanddelete()" style="background-color:#0ea3a9;margin-right:1px;" class="btn btn-flat pull-right"><i class="fa fa-refresh"></i> DELETE </a>
               
	
<?php 
if($Row->VoucherSource_Id == 4)
{
?>
			   <a <?php echo "href='" . site_url('') . "/" . "Accounts/Voucher/?Key=" . base64_encode($Row->Voucher_Id) . "'"; ?> style="background-color:#0ea3a9;margin-right:1px;" class="btn btn-flat pull-right"><i class="fa fa-pencil"></i>Edit
                  </a>
<?php }?>
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row invoice-info">
                                ...
                                <div class="col-sm-3 invoice-col pull-right">
                                    ...
                                    <b>Reference</b>: <?php echo $Row->Reference; ?></h2>
                                </div>
                            </div>
                            <div class="row invoice-info">
                                <!-- /.col -->
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo ($Products->amount>0) ? number_format($Products->amount,2) : number_format(0,2); ?></td>
														 <td><?php echo ($Products->amount<0) ? number_format(($Products->amount*-1),2) : number_format(0,2); ?></td>
                                                    </tr>
                                                <?php
    ...
    <iframe style="width:0px;height:0px;" src="<?php echo site_url('Accounts/Voucher_invoicePrint/?Key=' . $_GET['Key']); ?>" name="frame"></iframe>
<script>
        function askapprovalanddelete() {
          var r = confirm("This action will Delete the Voucher !");
          if (r == true) {
            document.getElementById("askapprovalanddelete").submit();
          }
        }
      </script>	   
	   <form id="askapprovalanddelete" method="POST" action="<?php echo site_url('Accounts/Voucher_Save'); ?>">
        <input type="hidden" name="User_Id" value="<?php echo $this->session->userdata['cosmolog']['UId'] ?>" />
        <input type="hidden" name="Voucher_Id" id="Voucher_Id" value="<?php echo $Row->Voucher_Id; ?>" />
		     <input type="hidden" name="Abut" id="Abut" value="DELETE" />		 
      </form>
<?php
}
?>
