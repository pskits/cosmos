    ...
    <div class="box box-form box-solid">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <a href="<?php echo site_url('Accounts/Accounts_Orderlist'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
        </div>
      </div>
      <div class="box-body">
      <br>
        ...
        <table id="Viewtable" class="display nowrap" style="width:100%">
          ...
          <tbody>
            ...
            foreach ($this->GM->Orderlist($status_id = 1, $Warehouseid = "0", $Dealer_Id = "0", $salesexecutiveuser_Id = "0", $priority_Id = "0", $Order_status_Id = "0", $Id = "0", $from_date, $to_date, $Accountstatus = 2) as $Row) {
            ?>
              <tr>
