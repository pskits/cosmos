        ...
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/AccountsByProfitLoss'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                <br>
                <form class="row form-inline">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-md Date" readonly required name="fromdate" placeholder="Enter date" value="<?php echo $fromdate = (isset($_REQUEST['fromdate'])) ? $_REQUEST['fromdate'] : '01-01-'.date('Y'); ?> ">
                ...
                <table class="table exporttable" style="width:100%">
                    <thead>
                        <tr>
                            <th style="width:60%" colspan="2">Particulars</th>
                            <th style="width:40%" colspan="2">Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        foreach ($this->ReportsClass->AccountsByProfitLossSales($from_date, $to_date) as $Row) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td  class="Currency"><?php echo ($Row->amounttype != 1) ? $amount : ''; ?></td>
                                <td  class="Currency"><?php echo ($Row->amounttype == 1) ?  $amount : ''; ?></td>
                            </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="Currency"><?php echo ($directexpect[0]->Master_amount < 0) ? ($directexpect[0]->Master_amount * -1) : $directexpect[0]->Master_amount; ?></td>
                        </tr>
                        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="Currency"><?php echo  $amount; ?></td>
                                <td></td>
                            </tr>
                        <?php
                        }
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="Currency"><?php echo $GROSS_PROFIT ?></td>
                        </tr>
                        <?php
                        ...
                        ?>
                         <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="Currency"><?php echo ($IndirectIncome[0]->Master_amount < 0) ? ($IndirectIncome[0]->Master_amount * -1) : $IndirectIncome[0]->Master_amount; ?></td>
                        </tr>
                       <?php
                      ...
                      ?>
                         <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td  class="Currency"><?php echo ($IndirectExpense[0]->Master_amount < 0) ? ($IndirectExpense[0]->Master_amount * -1) : $IndirectExpense[0]->Master_amount; ?></td>
                        </tr>
                       <?php
