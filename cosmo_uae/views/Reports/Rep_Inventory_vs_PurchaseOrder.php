    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Inventory VS Purchase Order</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/Rep_Inventory_vs_PurchaseOrder'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                 <table class="table exporttable" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $cou = 1;
                        foreach ($this->ReportsClass->Rep_Inventory_vs_PurchaseOrder() as $Row) {
							$style= ($Row->Trans_PurchaseOrderProduct_Quantity==$Row->quantity) ? '' : 'color:red;' ;
                        ?>
