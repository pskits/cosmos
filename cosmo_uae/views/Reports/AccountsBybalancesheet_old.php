                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td class="Currency"><?php echo ($masterRow->amount < 0) ?  ($masterRow->amount * -1) : 0;$loss +=($masterRow->amount < 0) ?  ($masterRow->amount * -1) : 0;
                                            echo ($masterRow->amount > 0) ?  $masterRow->amount : 0; $profit += ($masterRow->amount > 0) ?  $masterRow->amount : 0; ?></td>
                                    </tr>
                                    <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="Currency"><?php echo ($Row->amount < 0) ?  ($Row->amount * -1) : 0; $loss += ($Row->amount < 0) ?  ($Row->amount * -1) : 0;
                                                echo ($Row->amount > 0) ?  $Row->amount : 0; $profit += ($Row->amount > 0) ?  $Row->amount : 0; ?></td>
                                            <td></td>
                                        </tr>
                                    <?php
                                    }
