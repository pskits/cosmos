    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">By Product Nettotal</h3>
                 ...
                 <table class="table exporttable" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>Product Qty</th>
                            <th>Product Average Sale Price</th>
                            <th>Invoice Total</th>                            
                    ...
                    <tbody>
                        ...
                        foreach ($this->ReportsClass->Rep_SalesbyProductNettotal($from_date, $to_date) as $Row) {
                        ?>
                            <tr>
                                <td><b><?php echo $cou; ?></b></td>
                                <td><?php echo $Row->product; ?></td>                               
                                <td class="Currency"><?php echo $Row->ProductCategory; ?></td>
                                <td class="Currency"><?php echo $Row->InvoiceProduct_Quantity; ?></td>
                                <td class="Currency"><?php echo $Row->InvoiceProduct_total/$Row->InvoiceProduct_Quantity; ?></td>
