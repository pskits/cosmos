...
<div class="container">
	<div style="border: 1px solid #000;">
		...
		<tr><td><p><b><?php echo $office->office_Name; ?></b></p></td></tr>
...
<!-- ***************** { Bill Address End } ****************** -->
				...
				<tr style="border-top: 1px solid #000;">
					...
					<td colspan="5">
							...
							<div style="border-bottom: 1px solid #000;">
								...
								<p class="pull-right"><b><?php echo $Row->Invoice_total; ?></b></p>
							</div><br>
						</td>
				</tr>
			</tfoot>
		...
		<div style="border-top: 1px solid #000;padding-top:30px;">
		 	<table id="agreed" class="table table-borderless" style="margin-bottom:0px;">
			<tr style="border:none;"><td></td><td></td></tr>
			<tr style="border:none;"><td></td><td></td></tr>
		<tr >
		<td align="left" style="vertical-align:bottom;"><b>AGREED & ACCEPTED</b></td>
		<td align="right" style="vertical-align:bottom;"><b>تمت الموافقة عليها وقبولها</b></td>
		</tr>
		</table>
		</div>
	</div>
