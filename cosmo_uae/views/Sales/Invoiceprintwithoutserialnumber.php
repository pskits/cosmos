        ...
        <div class="col-12">
          ...
          <div class="invoice p-3 mb-3">
            ...
            <div class="row invoice-info">
              <div class="col-sm-6 invoice-col">
                ...
                <address>
                    ...
                    TRN: <?php echo $office->office_tax_no; ?>
            ...
            <div class="container">
              ...
              <table class="  table table-striped printtable" >
                    <thead>
                      <tr>
 ...
 <table class="table  table-striped">				
				<tbody>
                    ...
                    <tr><td style="border:none;">Account No </td>
					  ...
					  <td style="border:none;text-align:right;background-color:#afafaf;" colspan="4"><b>Round off</b></td>
					 
                      <td style="border:none;background-color:#afafaf;"> <?php echo $Row->Invoice_roundoff; ?></td>
                    </tr>
					 <tr><td style="border:none;">Account Type </td>
                      <td style="border:none;"><?php echo $bankDetails->account_type; ?></td>
					 <td style="border:none;text-align:right;background-color:#afafaf;" colspan="4"><b>Grand Total</b></td>
					 
                      <td style="border:none;background-color:#afafaf;font-weight:bold;font-size:16px;"> <?php echo $Row->Invoice_total; ?></td>
                    </tr>
