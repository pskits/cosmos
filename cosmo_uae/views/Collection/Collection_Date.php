            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
						...
						<?php 
							$userid=$this->session->userdata['cosmolog']['UId'];
							if($userid=67) {
						?>
						 <div class="form-group">
                            <label>Date</label>
                            <input type="text" class="form-control input-md Date" required readonly name="CollectionDate" 
							placeholder="Enter date" value="<?php if(isset($_POST['CollectionDate'])) { echo date('d-m-Y',strtotime($_POST['CollectionDate']))  ;} ?>">
                            <br> <?php echo form_error('CollectionDate'); ?>
                        </div>
						<?php } else { $_POST['CollectionDate']='getdate()'; }	?>
