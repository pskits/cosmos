    ...
    <div class="box box-form box-solid">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <a href="<?php echo site_url('Collection/Collection_View'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
        </div>
      </div>
      <div class="box-body">
        <br>
        ...
        <table id="Viewtable" class="display nowrap" style="width:100%">
          ...
          <tbody>
            ...
            foreach ($this->GM->Collection($status = "1", $dealer = "0", $collectedUser_Id = "0", $portal_Id = "0", $process_Id = "0", $amountmode_Id = "0", $CollectionStatus_Id = "0", $Id = "0", $from_date, $to_date, $accountstatus=1) as $Row) {
            ?>
              <tr>
