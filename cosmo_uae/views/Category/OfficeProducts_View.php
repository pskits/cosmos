...
<div class="content-wrapper">
 ...
 <td><?php echo $Row->CashRate; ?></td> 				
                <td><?php echo $Row->Commission; ?></td>      
                <td><?php echo $Row->PlumberCommision; ?></td>                
                <td><?php echo $Row->StatusName; ?></td>
              <td>                  <a <?php echo "href='" . site_url('Category/OfficeProducts') ."/?Key=" . base64_encode($Row->Product_Id) . "'"; ?>>
							<span class="badge"><i class="fa fa-pencil"></i>&nbsp; Edit</span>
                    </td>
