  ...
  <section class="content">
    <div class="box box-form box-solid">
      ...
      <div class="box-body">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label>Country</label>
              <select id="Country_Id" required class="form-control select2" name="Country_Id">
                <?php
      ...
      <div class="box-footer" >
        <a href="<?php echo site_url('Category/State_view'); ?>" class="btn btn-flat bg-red"><i class="fa fa-times"></i> Cancel</a>
