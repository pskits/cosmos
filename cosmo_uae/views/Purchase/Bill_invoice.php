...
?>
        ...
        <div class="row">
          <div class="col-12">
            <div class="callout callout-info row">
              <h4 class="col-md-4"><b> <?php echo $Row->Bill_code ; ?></b></h4>
              <div class="col-md-8">
                ...
                <a href="<?php echo site_url('Purchase/Bill_View'); ?>" style="background-color:#0ea3a9;margin-right:1px;" class="btn btn-flat pull-right"><i class="fa fa-arrow-circle-left"></i> </a>
              </div>
            </div>
  ...
  <iframe style="width:0px;height:0px;" src="<?php echo site_url('Purchase/Bill_invoicePrint/?Key=' . $_GET['Key']); ?>" name="frame"></iframe>
