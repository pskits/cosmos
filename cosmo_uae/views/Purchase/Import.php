...
?>
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <input type="number" value="1.000" min="0.001" step="0.001" class="form-control input-md" onkeyup="Caltotal()" onkeydown="Caltotal()" onchange="Caltotal()" required name="Conversion_Rate" placeholder="Enter Conversion" id="covrate" value="<?php echo @set_value('Conversion_Rate') . @$Conversion_Rate; ?>">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <input type="number" readonly onchange="Caltotal()" class="form-control input-md" id="productrateorg" step="0.001" min="0.001" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required="" name="Rateorg[<?php echo $count; ?>]" placeholder="Enter Rate" value="<?php echo $Products->Trans_PurchaseOrderProduct_Rate ?>">
                          <br>
                          <input type="number" readonly onchange="Caltotal()" class="form-control input-md" id="productrate" step="0.001" min="0.001" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required="" name="Rate[<?php echo $count; ?>]" placeholder="Enter Rate" value="<?php echo $Products->Trans_PurchaseOrderProduct_Rate ?>">
                          <br>
                        </td>
                        <td>
                          <input type="text" class="form-control input-md" id="orgproductamount" step="0.001" min="0.001" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required="" readonly="" 
						  name="orgproductamount[<?php echo $count; ?>]" value="<?php echo number_format(($Products->Trans_PurchaseOrderProduct_Rate*$Products->Trans_PurchaseOrderProduct_Quantity), 3) ?>">
                          <br>
                          <input type="number" class="form-control input-md" id="productamount" step="0.001" min="0.001" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" 
						  required="" readonly="" name="productamount[<?php echo $count; ?>]" value="<?php echo $Products->Trans_PurchaseOrderProduct_Grandtotal ?>">
              ...
              <div class="table-responsive">
                <table class="table">
                  <tr>
                    ...
                    <td><input type="text" class="borderless" name="PurchaseOrder__Subtotal" required readonly id="PurchaseOrder__Subtotal" 
					value="<?php echo $Row->PurchaseOrder__Subtotal; ?>"></td>
                  </tr>
				  <tr>
                    <th style="width:50%">Fright</th>
                    <td><input type="text" class="borderless" name="fright" required readonly id="PurchaseOrder__fright" 
					value="<?php echo $Row->fright; ?>"></td>
                  </tr>
				  <tr>
                    <th style="width:50%">Insurance</th>
                    <td><input type="text" class="borderless" name="insurance" required readonly id="PurchaseOrder__insurance" 
					value="<?php echo $Row->insurance; ?>"></td>
                  </tr>
                  <tr>
                    <th>Total</th>
                    <td><input type="text" class="borderless" id="PurchaseOrder_GrandTotalAmount" 
					required readonly name="PurchaseOrder_GrandTotalAmount" value="<?php echo $Row->PurchaseOrder__Subtotal; ?>"></td>
                  </tr>
                </table>
              </div>
            </div>
  ...
  <script>
    function Caltotal() {
      ...
      covrate = parseFloat(covrate).toFixed(3);
 var fright = document.getElementById('PurchaseOrder__fright').value; 
	  var insurance = document.getElementById('PurchaseOrder__insurance').value;    
var fright =  (parseFloat(covrate) * parseFloat(fright)).toFixed(3);
var insurance =  (parseFloat(covrate) * parseFloat(insurance)).toFixed(3);	  
	 $("input[id='productqty']").each(function(index) {
        ...
        var productdiscount = "0.000";
        var discountval = "0.000";
        var Taxpercentage = "0.000";
        var total = "0.000";
        var output = "0.000";
        //get values
        qty = $("input[id='productqty']").eq(index).val();
        rate = parseFloat($("input[id='productrateorg']").eq(index).val()).toFixed(3);
        //validation
        qty = ((isNaN(qty)) ? '0' : qty);
		...
		var total =  (parseFloat(covrate) * parseFloat(total)).toFixed(3);
        var output = total;
		...
		//totalPrice = (parseFloat(PurchaseOrderSubtotal) + parseFloat(fright) + parseFloat(insurance) + parseFloat(total)).toFixed(3);
	   ...
	   totalPrice = ((isNaN(totalPrice)) ? '0' : totalPrice);
		 ...
		 var totalPrice =  (parseFloat(fright) + parseFloat(insurance) + parseFloat(totalPrice)).toFixed(3);
