                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
						  ...
						  <div class="form-group">
                            <label>Trip Employee</label> 
                            <select id="TripEmployeeUser_Id" required class="form-control select2" name="TripEmployeeUser_Id">
                                <?php
							
                                $data = $this->GM->Users($userrole_id = "1", $Status_Id = 0, $id = "0");								
								$data1 = $this->GM->Users($userrole_id = "2", $Status_Id = 0, $id = "0");$data=array_merge($data,$data1);
								$data1 = $this->GM->Users($userrole_id = "3", $Status_Id = 0, $id = "0");$data=array_merge($data,$data1);
								$data1 = $this->GM->Users($userrole_id = "4", $Status_Id = 0, $id = "0");$data=array_merge($data,$data1);
								$data1 = $this->GM->Users($userrole_id = "5", $Status_Id = 0, $id = "0");$data=array_merge($data,$data1);
								$data1 = $this->GM->Users($userrole_id = "9", $Status_Id = 0, $id = "0");$data=array_merge($data,$data1);
								$data1 = $this->GM->Users($userrole_id = "10", $Status_Id = 0, $id = "0");$data=array_merge($data,$data1);
								
								
                                $this->GM->Option_($data, 'logincredentials_Id', 'name', '', 'Select', @set_value('TripEmployeeUser_Id') . @$TripEmployeeUser_Id);
                                ?>
                            </select>
                            <?php echo form_error('TripEmployeeUser_Id'); ?>
                        </div>
                        <div class="form-group">
