...
class Reports extends CI_Controller
{
 ...
 public function Inventorypurchaseorder()
    {
        $this->load->view('Reports/Inventory_purchaseorder');
    }
	...
	public function InventoryPurchaseOrderDetails()
    {
        $this->load->view('Reports/InventoryPurchaseOrderDetails');
    }
    ...
    // Replacement Report
	public function ReturnbyReplacementInvoiceNo()
    {
        $this->load->view('Reports/ReturnbyReplacementInvoiceNo');
    }
