...
class ReportsClass extends CI_Model
{
	...
	//Rep_AccountsByProfitLossSalesOLD
	function AccountsByProfitLossSalesOLD($from_date, $to_date)
	{
		$res = $this->db->query("exec ".$_SESSION['currentdatabasename'].".dbo.Rep_AccountsByProfitLossSalesOLD  '" . $from_date . "','" .  $to_date . "'");
		// echo $this->db->last_query();exit;
		return $res->result();
	}
	//By Product
