    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Trial Balance (V 1.0)</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/AccountsByTrialBalance_Oldversion'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                  <a href="<?php echo site_url('Reports/AccountsByTrialBalance'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> New Version</a>
                ...
                <form class="row form-inline">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="forminline-label">Till : </label>
                ...
                <hr class="horizondal-splitter">
                    ...
                    <table id="Reptable" class="table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            foreach ($this->ReportsClass->AccountsByTrialBalance('01/01/2018', $to_date) as $Row) {
