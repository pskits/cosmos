                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $Row->opening_good; ?></td>
                                <td><?php echo $Row->opening_damaged; ?></td>
                                <td><?php echo $Row->import; ?></td>
                                <td><?php echo $Row->invoice; ?></td>
                                <td><?php echo $Row->salesreturn; ?></td>
                                <td><?php echo $Row->warrantyreturn; ?></td>
                                <td><?php echo $Row->goodsjournal; ?></td>
                                <td><?php echo $Row->closing_good; ?></td>
								<td><?php echo $Row->closing_damaged; ?></td>
                            </tr>
                        <?php
                            $cou++;
                        }
