    ...
    <section class="content">
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">DateWise Goods</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/InventorySummary_DateWise'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
            <br>
                ...
                <hr class="horizondal-splitter">
                 <table class="table exporttable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($this->ReportsClass->InventorySummary_DateWise($from_date, $to_date) as $Row) {
                        ?>
                            <tr>
                    ...
                    <tfoot><?php $tablecolumntotallist = array('3', '4'); ?>
                        <td>Total</td>
                        <td></td>
                        <td></td>
                        <td></td>
