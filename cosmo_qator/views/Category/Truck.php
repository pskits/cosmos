...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-form box-solid">
            ...
            <?php echo form_open_multipart(site_url('Category/Truck_Save') , 'role="form"'); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <input class="form-control" id="val1" onchange="dimention();" value="0" onfocus="dimentionclr();"  required step="1" id="ex1" type="number">
                                </div>
                                <div class="col-xs-3">
                                    <input class="form-control" id="val2" onchange="dimention();" value="0" onfocus="dimentionclr();" step="1" required id="ex1" type="number">
                                </div>
                                <div class="col-xs-3">
                                    <input class="form-control" id="val3" onchange="dimention();" value="0" onfocus="dimentionclr();"  step="1" id="ex2" required type="number">
                                </div>
                                <div class="col-xs-3">
                                    <input class="form-control" id="val4" onchange="dimention();" value="0" onfocus="dimentionclr();" step="1" id="ex3" required type="number">
                                </div>
                            </div>
                            <br />
