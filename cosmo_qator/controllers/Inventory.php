...
class Inventory extends CI_Controller
{
    ...
    //10-01-2022
    public function GoodsTranferExternal(){
        $countries = array(5=>'Qatar',2=>'Uae');
        $source_country_id =5;
        $data = array('But' => 'Save', 'Icon' => 'fa fa-check', 'BtnColor' => 'bg-Green text-Green','countries' =>$countries,'source_country_id'=>$source_country_id);
        $this->load->view('Inventory/GoodsTranferExternal',$data);   
    }
    public function GoodsTransfer_Save_External()
    {
        if ($this->InventoryClass->GoodsTransferGoods_Validation()) {
            $this->InventoryClass->GoodsTransfer_Save_External();
        }
    }
}
