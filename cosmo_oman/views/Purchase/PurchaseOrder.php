...
var PurchaseOrder_TotalInsuranceAmount = document.getElementById('PurchaseOrder_TotalInsuranceAmount').value; 
    ...
    var Taxval = ((parseFloat(total) / 100) * parseFloat(Taxpercentage)).toFixed(3);
...
totalPrice = (parseFloat(totalPrice) + parseFloat(PurchaseOrder_TotalFrightAmount)).toFixed(3);
	
   
			      totalPrice = (parseFloat(totalPrice) + parseFloat(PurchaseOrder_TotalInsuranceAmount)).toFixed(3);
