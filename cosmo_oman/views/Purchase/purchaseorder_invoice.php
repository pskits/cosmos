                  ...
                  <address>
                    ...
                    <p style="width:70%;margin:0px;">
                     <?php echo $Row->Address; ?>, <?php echo $Row->City; ?>, <br>
					   <?php echo $Row->StateName; ?>, <?php echo $Row->CountryName; ?> - <?php echo $Row->Postcode; ?>.
                    </p>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo number_format((float)$Products->Trans_PurchaseOrderProduct_Discount, 3, '.', ''); ?></td>
