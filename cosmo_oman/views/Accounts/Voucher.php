...
<div class="content-wrapper">
    ...
    <section class="content">
		...
		step="0.001" min="0.000" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required="" 
...
function Deleterow(btn) {
    ...
    function AddExpenceRow() {
        ...
        cell2.innerHTML = `<input type="number" onchange="calAmount()" class="form-control input-md Credit" id="InvoicePayAmount" Value="" step="0.001" min="0.000" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required name="Credit[` + rows + `]" >`;
        cell3.innerHTML = `<input type="number" onchange="calAmount()" class="form-control input-md Debit" id="InvoicePayAmount" Value="" step="0.001" min="0.000" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required name="Debit[` + rows + `]" >`;
