        ...
        <section class="content">
            <div class="box box-form box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">General Ledger Book</h3>
        ...
        <section class="content">
            <div class="box box-form box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">General Ledger Book</h3>
                    <div class="box-tools pull-right">
                        <a href="<?php echo site_url('Reports/AccountsByAccountsGroupGeneralLedger'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
<a onclick="frames['LedgerPrint'].print()" class="btn btn-flat"><i class="fa fa-file-pdf-o"></i> </a>
                    ...
                    <hr class="horizondal-splitter">
                     <table class="table exporttable" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $from_date = $this->GM->DateSplit($fromdate);
                            $to_date = $this->GM->DateSplit($todate); 
                            foreach ($this->ReportsClass->AccountsByAccountsGroupGeneralLedger($from_date, $to_date, $_GET['OfficeLedger_id']) as $Row) {
                            ?>
                                <tr>
                                    ...
                                    <td class="Currency"><?php echo $Row->debit; ?></td>
                                    <td class="Currency"><?php echo $Row->credit; ?></td>
                        ...
                        <tfoot><?php $ordering = 'false';
                                $tablecolumntotallist = array('4', '5'); ?>
                            <td>Total</td>
                            <td></td>                          
                            <td></td>
                            <td></td>
...
<div class="col-md-8">
  ...
  <iframe style="width:0px;height:0px;" src="<?php echo site_url('Reports/AccountsByAccountsGroupGeneralLedger_PDF/?OfficeLedger_id=' . $_GET['OfficeLedger_id'].'&fromdate='. $_GET['fromdate'].'&todate'. $_GET['todate']); ?>" name="LedgerPrint"></iframe>
