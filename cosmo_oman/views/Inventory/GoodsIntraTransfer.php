                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group">
                            <label>Product_Id</label>
                            	<select  id="Product" class="form-control select2 productname" required name="Product_Id">
						<?php
...
<script>
    function calAmount() {
        ...
        $(".Invoice_Id:checked").each(function(index) {
            InvoiceTotal = (parseFloat(InvoiceTotal) + parseFloat($(".Invoice_Id").eq(index).attr('max'))).toFixed(3);
        });
