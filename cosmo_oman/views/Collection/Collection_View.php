      ...
      <div class="box-body">
        ...
        <table id="Viewtable" class="display nowrap" style="width:100%">
          ...
          <tbody>
            ...
            foreach ($this->GM->Collection($status = "1", $dealer = "0", $collectedUser_Id = "0", $portal_Id = "0", $process_Id = "0", $amountmode_Id = "0", $CollectionStatus_Id = "0", $Id = "0", $from_date, $to_date) as $Row) {
            ?>
              <tr>
