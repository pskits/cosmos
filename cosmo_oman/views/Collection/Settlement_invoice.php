...
?>
                    ...
                    <div class="col-12">
                        <div class="callout callout-info row">
                            ...
                            <div class="col-md-8">
                                ...
                                <a href="<?php echo site_url('Collection/Settlement_view'); ?>" style="background-color:#0ea3a9;margin-right:1px;" class="btn btn-flat pull-right"><i class="fa fa-arrow-circle-left"></i> </a>
                            </div>
                        </div>
                        <!-- Main content -->
                                ...
                                <div class="col-12 table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $count = "0";
                                            $total = 0.000;
                                            foreach ($this->GM->SettlementCollection($status = "0", $Row->Settlement_Id,  $Id = "0") as $Products) {
                                                $count++;
                                            ?>
                                                <tr>
                                                    <td><?php echo $count; ?></td>
                                                    <td> <a href="<?php echo site_url('Collection/Collection_invoice/?Key').base64_encode($Products->Collection_Id); ?>" ><?php echo $Products->Collection_no; ?> </td>
    ...
    <iframe style="width:0px;height:0px;" src="<?php echo site_url('Collection/Settlement_invoicePrint/?Key=' . $_GET['Key']); ?>" name="frame"></iframe>
<?php
}
?>
