        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" class="form-control input-md"  step=".01" min="0.000"
			  onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required name="Rate" placeholder="Enter Credit Rate"
 value="<?php echo @set_value('Rate') . @$Rate; ?>">
              <?php echo form_error('Rate'); ?>
            </div>
			 <div class="form-group">
              <label>Cash Rate</label>
              <input type="number" class="form-control input-md"  step=".01" min="0.000"
			  onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required name="CashRate" placeholder="Enter Cash Rate"
 value="<?php echo @set_value('CashRate') . @$CashRate; ?>">
              <?php echo form_error('CashRate'); ?>
            </div>
            <div class="form-group">
              <label>Commission</label>
              <input type="number" class="form-control input-md" step=".01" min="0.000" 
			  onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required name="Commission" placeholder="Enter Commission" 
			  value="<?php echo @set_value('Commission') . @$Commission; ?>">
            ...
            <div class="form-group">
			  ...
			  name="PlumberCommision" placeholder="Enter PlumberCommision" value="<?php echo @set_value('PlumberCommision') . @$PlumberCommision; ?>">
              <?php echo form_error('PlumberCommision'); ?>
            </div>
            <div class="form-group">
              <label>Warrenty Days</label>
              <input type="number" class="form-control input-md"  step="1" min="0" 
			  onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required name="Warrenty_days" 
			  placeholder="Enter Warrenty_days" value="<?php echo @set_value('Warrenty_days') . @$Warrenty_days; ?>">
