  ...
  <section class="content">
    <div class="box box-form box-solid">
      <div class="box-header with-border">
        <h3 class="box-title">Credit Note View</h3>
        <div class="box-tools pull-right">
          <a href="<?php echo site_url('Accounts/CreditNote_View'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
        </div>
      </div>
      <div class="box-body">
        <br>
        ...
        <table id="Viewtable" class="display nowrap" style="width:100%">
          ...
          <tbody>
            ...
            foreach ($this->GM->CrediNote($status = "1", $dealer = "0", $CreditNoteUser_Id = "0", $CreditNoteStatus_Id = "0", $Id = "0", $from_date, $to_date) as $Row) {
            ?>
              <tr>
                <td><b><?php echo $cou; ?></b></td>
                <td><?php echo $Row->Creditnote_no; ?></td>
                <td><?php echo $Row->Creditnote_Dateformatted; ?></td>
                <td><?php echo $Row->CrediNoteuseremail; ?></td>
                <td><?php echo $Row->name; ?></td>
                <td><?php echo $Row->amount; ?></td>
                <td>
                  <a <?php echo "href='" . site_url('') . "/" . "Accounts/CreditNote_invoice/?Key=" . base64_encode($Row->Creditnote_Id) . "'"; ?>><span class="badge"><i class="fa fa-eye"></i>&nbsp; View</span>
                  </a>
                </td>
              </tr>
            <?php
