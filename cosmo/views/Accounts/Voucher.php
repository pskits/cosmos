...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-form box-solid">
            ...
            <?php echo form_open_multipart(site_url('Accounts/Voucher_') . $But . '/', 'role="form"'); ?>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Date</label>
                            <input type="text" class="form-control input-md Date" required readonly name="Voucher_date" placeholder="Enter date" value="<?php echo @set_value('Voucher_date') . @$Voucher_date; ?>">
