        ...
        <table id="Viewtable" class="display nowrap" style="width:100%">
          <thead>
            <tr>
              ...
              <th>PurchaseOrder Expected Date</th>
              <th>Supplier Name</th>
              <th>Currency</th>
              <th>Warehouse</th>
              <th>Status</th>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a <?php echo "href='" . site_url('') . "/" . "Purchase/purchaseorder_invoice/?Key=" . base64_encode($Row->PurchaseOrder_Id) . "'"; ?>><span class="badge"><i class="fa fa-eye"></i>&nbsp; View</span>
                  </a>
                </td>
              </tr>
            <?php
