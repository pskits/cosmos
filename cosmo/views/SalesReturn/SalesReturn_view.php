                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                          <?php
                          $AdjustmentAmount = number_format(($InvoiceAmountInfo->Collection_Amount) - ($Row->SalesReturn_total + $InvoiceAmountInfo->SalesReturnPayed_Amount), 2);
                        }
                        if ($InvoiceAmountInfo->Collection_Amount > $InvoiceAmountInfo->Invoice_total) {
                          echo "Contact System Admin";
                        }
                        $AdjustmentAmount = ($AdjustmentAmount > '0.00') ? $AdjustmentAmount : '0.00';
