  ...
  <section class="content">
    <div class="box box-form box-solid">
      <div class="box-header with-bInvoice">
        <h3 class="box-title">Invoice Over Due View</h3>
        <div class="box-tools pull-right">
          <a href="<?php echo site_url('Sales/InvoiceOverDue'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
        </div>
      </div>
      <div class="box-body">
        <table id="Viewtable" class="display nowrap" style="width:100%">
          <thead>
		  <tr >
		 <th style="text-align:center;" Colspan="6">Over Due Details</th>
          ...
          <tbody>
            <?php          
            foreach ($this->GM->InvoiceOverDue($status_id = 1, $Dealer_ID = "0", $Invoice_Id = "0", $salesexecutiveid = "0") as $Row) {        
             ?>
              <tr >
                ...
                <td><?php echo $Row->InvoiceDue_DateFormatted; ?></td>                
                             <td><b><?php echo $Row->overDueDateDiff; ?></b></td>
