            ...
            <div class="box-body">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li class="pull-left header"><i class="fa fa-user"></i> Trip</li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1-1">
                            <b>Details</b>
                            <?php
                            foreach ($this->GM->Trip($status_Id = "1", $warehouse_id = "0", $area_Id = "0", $Truck_Id = "0", $Driver_Id = "0", $Helper_Id = "0", $Trip_status_Id = "0", $Id, '', '') as $Trip) {
                            ?>
                                ...
                                <?php if ($Trip->TripStatus_Id == '1') { ?>
                                    <form method="post" action="<?php echo site_url("Inventory/TripDeliveries_Save"); ?>" class="form-inline ">
                                        ...
                                        <div style="margin-left:5px;" class=" form-group">
                                            ...
                                            <select class="form-control select2" required name="against_id">
                                                <?php
                                                $data = $this->GM->AvailableDeliveriesForTrip($Trip->warehouse_Id, $Trip->area_Id, '1');
                                    ...
                                    <form method="post" action="<?php echo site_url("Inventory/TripDeliveries_Save"); ?>" class="form-inline ">
                                        ...
                                        <div style="margin-left:5px;" class=" form-group">
                                            ...
                                            <select class="form-control select2" required name="against_id">
                                                <?php
                                                $data = $this->GM->AvailableDeliveriesForTrip($Trip->warehouse_Id, $Trip->area_Id, '2');
                                                $this->GM->Option_($data, 'ID', 'No', '', 'Select', '0');
                                                ?>
                                            </select>
                                            <?php echo form_error('against_id'); ?>
