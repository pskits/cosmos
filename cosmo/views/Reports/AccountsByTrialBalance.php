        ...
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/AccountsByAlltransaction'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                <br>
                <form class="row form-inline">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-md Date" readonly required name="fromdate" placeholder="Enter Admin fromdate" value="<?php echo $fromdate = (isset($_REQUEST['fromdate'])) ? $_REQUEST['fromdate'] : '01-01-2017'; ?> ">
                ...
                <?php } else { ?>
                    <table id="Reptable" class="table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td><a href="<?php echo site_url('Reports/AccountsByAccountsGroup') . '/?Accountsgroup_Id=' . $Row->Accountsgroup_ParentId; ?> ">
                            ...
                            foreach ($this->ReportsClass->AccountsByTrialBalanceProfitLoss('01/01/2018', $from_date) as $ProfitlossRow) {
                            ?>
                                <tr>
                                    <td><a href="<?php echo site_url('Reports/AccountsByprofitloss') . '/?fromdate=01-01-2018&todate=' . $from_date; ?> ">Profit and Loss</a>
									<br><span style="font-size:12px;"><?php echo $ProfitlossRow->calculateddate;?></span></td>
                                    <td></td>
                                    <td><?php echo ($ProfitlossRow->NetProfit < 0) ?  ($ProfitlossRow->NetProfit * -1) : 0; ?></td>
                                    <td><?php echo ($ProfitlossRow->NetProfit > 0) ?  $ProfitlossRow->NetProfit : 0; ?></td>
                                </tr>
                            <?php
                            }
                            ?>
