        ...
        <div class="box box-form box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo site_url('Reports/ReturnbyProduct'); ?>" class="btn btn-flat "><i class="fa fa-refresh"></i> Refresh</a>
                </div>
            </div>
            <div class="box-body">
                <br>
                ...
                <hr class="horizondal-splitter">
                 <table class="table exporttable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        $cou = 1;
                        foreach ($this->ReportsClass->ReturnbyProduct($from_date, $to_date) as $Row) {
                        ?>
                            <tr>
