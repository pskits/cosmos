  ...
  <section class="content">
    <div class="box box-form box-solid">
      <div class="box-header with-border">
        <h3 class="box-title">Settlement Non Deposited</h3>
      ...
      <div class="box-body">
        ...
        <table id="Viewtable" class="display nowrap" style="width:100%">
          ...
          <tbody>
            <?php
            $cou = 1;
            foreach ($this->GM->SettlementNondeposited($status = "1", $SettlementedUser_Id = "0", $CollectedUser_Id = "0", $amountmode_Id = "0", $Id = "0", $from_date='', $to_date='') as $Row) {
            ?>
              <tr>
